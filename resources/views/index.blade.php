...
<head>
    ...
    <link rel="stylesheet" href="http://cdn.bootcss.com/toastr.js/latest/js/toastr.min.js">
...
<body>
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Gestão Comercial</a>
